import {fields,element,renderBody,coverUrl,dateLabel,readTime} from './archive-common.js';
...
async function load(){
  ...
  try{
    ...
    const url=coverUrl(data.cover_path);if(url){const image=element('img','','archive-article-cover');image.src=url;image.alt=data.cover_alt;article.append(image);}
